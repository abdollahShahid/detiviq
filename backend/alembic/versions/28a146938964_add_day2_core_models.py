...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("planned", "in_transit", "completed", "cancelled", name="load_status"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("organization_id", sa.Integer(), nullable=False),
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column("scope_type", sa.Enum("facility", "customer", "organization_default", name="ruleset_scope"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("planned", "arrived", "loading", "departed", "completed", name="stop_status"), nullable=False),
    ...
    op.add_column(
        "users",
        sa.Column("role", user_role_enum, server_default="admin", nullable=False),
    )
    op.add_column(
        "users",
